...
ALTER TABLE storage.objects ALTER COLUMN owner_id SET DEFAULT auth.uid();
...
AS $$
DECLARE
  project_url TEXT := 'https://airmsijsztespiduujkq.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImFpcm1zaWpzenRlc3BpZHV1amtxIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTczOTA2MjY5OSwiZXhwIjoyMDU0NjM4Njk5fQ.OXNdIkz0LvzaqbP6ygNtlILG_o6BHST3goGKyGwGCmk'; -- full access needed for http request to storage
